 ...
 */
class FinishExam extends \AdminBundle\Entity\FinishExam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\FinishExam' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\FinishExam' . "\0" . 'exam', '' . "\0" . 'AdminBundle\\Entity\\FinishExam' . "\0" . 'user', '' . "\0" . 'AdminBundle\\Entity\\FinishExam' . "\0" . 'score', '' . "\0" . 'AdminBundle\\Entity\\FinishExam' . "\0" . 'course'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FinishExam $proxy) {
