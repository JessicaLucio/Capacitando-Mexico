 ...
 */
class Unidad extends \AdminBundle\Entity\Unidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Unidad' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\Unidad' . "\0" . 'name', '' . "\0" . 'AdminBundle\\Entity\\Unidad' . "\0" . 'course'];
        }
