 ...
 */
class InfoCourse extends \AdminBundle\Entity\InfoCourse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\InfoCourse' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\InfoCourse' . "\0" . 'body', '' . "\0" . 'AdminBundle\\Entity\\InfoCourse' . "\0" . 'course'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InfoCourse $proxy) {
