 ...
 */
class Inscription extends \AdminBundle\Entity\Inscription implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Inscription' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\Inscription' . "\0" . 'course', '' . "\0" . 'AdminBundle\\Entity\\Inscription' . "\0" . 'user'];
        }
