 ...
 */
class FileExam extends \AdminBundle\Entity\FileExam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\FileExam' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\FileExam' . "\0" . 'file', '' . "\0" . 'AdminBundle\\Entity\\FileExam' . "\0" . 'course', '' . "\0" . 'AdminBundle\\Entity\\FileExam' . "\0" . 'unidad', '' . "\0" . 'AdminBundle\\Entity\\FileExam' . "\0" . 'remitente', '' . "\0" . 'AdminBundle\\Entity\\FileExam' . "\0" . 'destinatario'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FileExam $proxy) {
