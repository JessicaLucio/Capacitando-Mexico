 ...
 */
class Exam extends \AdminBundle\Entity\Exam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Exam' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\Exam' . "\0" . 'name', '' . "\0" . 'AdminBundle\\Entity\\Exam' . "\0" . 'unidad'];
        }
