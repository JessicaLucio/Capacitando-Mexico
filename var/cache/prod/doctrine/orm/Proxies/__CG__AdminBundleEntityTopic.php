 ...
 */
class Topic extends \AdminBundle\Entity\Topic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Topic' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\Topic' . "\0" . 'name', '' . "\0" . 'AdminBundle\\Entity\\Topic' . "\0" . 'body', '' . "\0" . 'AdminBundle\\Entity\\Topic' . "\0" . 'course', '' . "\0" . 'AdminBundle\\Entity\\Topic' . "\0" . 'unidad'];
        }
