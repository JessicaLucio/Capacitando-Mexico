 ...
 */
class File extends \AdminBundle\Entity\File implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\File' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\File' . "\0" . 'name', '' . "\0" . 'AdminBundle\\Entity\\File' . "\0" . 'file', '' . "\0" . 'AdminBundle\\Entity\\File' . "\0" . 'course', '' . "\0" . 'AdminBundle\\Entity\\File' . "\0" . 'unidad', '' . "\0" . 'AdminBundle\\Entity\\File' . "\0" . 'topic', '' . "\0" . 'AdminBundle\\Entity\\File' . "\0" . 'logotipo'];
        }
    ...
    public function setLogotipo($logotipo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLogotipo', [$logotipo]);
    ...
    public function getLogotipo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLogotipo', []);
