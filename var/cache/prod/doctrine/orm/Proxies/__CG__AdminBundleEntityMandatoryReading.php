 ...
 */
class MandatoryReading extends \AdminBundle\Entity\MandatoryReading implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\MandatoryReading' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\MandatoryReading' . "\0" . 'name', '' . "\0" . 'AdminBundle\\Entity\\MandatoryReading' . "\0" . 'url', '' . "\0" . 'AdminBundle\\Entity\\MandatoryReading' . "\0" . 'course', '' . "\0" . 'AdminBundle\\Entity\\MandatoryReading' . "\0" . 'unidad'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MandatoryReading $proxy) {
