...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the public 'app.notification_service' shared service.
     *
     * @return \AdminBundle\Services\NotificationService
     */
    protected function getApp_NotificationServiceService()
    {
        return $this->services['app.notification_service'] = new \AdminBundle\Services\NotificationService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('bknVrR+AmT', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LDTSZp3+ff', 0, '-DblE6+T3HQNZDO4+TIjRX', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'capacita_capmexico', 'user' => 'capacita', 'password' => 'ru7+[U4dYK4g4O', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_a06a9363e94f74bc936c0a40fb2776c10c1ad76ce65475a7795758721fb0bb08');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AdminBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 4))));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \AdminBundle\Twig\InscriptionExtension($a));
        $instance->addExtension(new \AdminBundle\Twig\FinishExamExtension($a));
        $instance->addExtension(new \AdminBundle\Twig\UploadExamExtension($a));
        $instance->addExtension(new \AdminBundle\Twig\AverageAdminExtension($a));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fNvhqbG1kq', 0, '-DblE6+T3HQNZDO4+TIjRX', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.user_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AdminBundle:User', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'capacita_capmexico',
            'database_user' => 'capacita',
            'database_password' => 'ru7+[U4dYK4g4O',
